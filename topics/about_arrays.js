...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(1, 4);

    ok(workingWeek.equalTo(['Tuesday', 'Wednesday', 'Thursday', 'Friday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Monday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
